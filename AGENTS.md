...
reference/CREDITS.md      — Licence and provenance for the committed reference recordings (CC BY 4.0). `reference/` is otherwise gitignored; only the licensed medium-pitch head-strike subset is tracked
